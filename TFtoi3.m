...
for spk = 1 : length(allSpks)
    ...
    cfg          = [ ];
    cfg.trl      = [encTrig-TW(1)-3000 encTrig-1+TW(2)+3000 zeros(size(encTrig))]; % -1s to +5s plus wings
...
% freqRes = trlPow.freq;
save('\\analyse4.psy.gla.ac.uk\project0309\Luca\data\allSbj\TFtoi3.mat', 'allSpks', '-v7.3')
